...
echo [4/5] Installing pywin32 (HWP COM support)...
"%PYTHON%" -m pip install --disable-pip-version-check pywin32
echo [5/5] Installing olefile (HWP binary parser)...
"%PYTHON%" -m pip install --disable-pip-version-check olefile
echo.
