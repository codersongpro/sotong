...
rem ---- Build EXE ----
echo Building exe...
"%PYTHON%" -m PyInstaller --onefile --windowed --name "소통픽" --hidden-import pyperclip --hidden-import openpyxl --hidden-import PIL "%SCRIPT%"
...
echo.
echo Build complete: dist\소통픽.exe
echo.
pause
