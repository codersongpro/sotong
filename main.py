...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  │   ② 검색 결과가 나타나면 [추가] 버튼이 보입니다.            │
  │      [📍 위치 설정] 버튼을 클릭합니다.                     │
  │   ③ 5초 안에 소통메신저의 [추가] 버튼 위에 마우스를 올리세요.│
  └─────────────────────────────────────────────────────────┘
  ┌─────────────────────────────────────────────────────────┐
  │ 검색 설정                                                 │
...
class App:
    ...
    def _do_capture(self, key: str):
        ...
        labels = {'search_field': '검색 입력창', 'add_button': '추가 버튼'}
    ...
    def _refresh_calib_labels(self):
        for key in ('search_field', 'add_button'):
    ...
    def _do_select(self) -> str:
        """추가 버튼 클릭 후 팝업 여부로 결과 반환: 'ok' | 'duplicate'"""
        x = self.config.data['add_button_x']
        y = self.config.data['add_button_y']
        time.sleep(0.2)
        pyautogui.click(x, y)
        time.sleep(0.4)
