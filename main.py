...
■ 이 프로그램이 하는 일
──────────────────────────────────────────────────────
  엑셀·한글 문서의 명단(소속기관 + 이름)을 입력하면
  충북 소통메신저에서 자동으로 검색하고 추가해 줍니다.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  5. 소통메신저 창과 {APP_NAME} 창을 화면에 나란히 배치하면 편리합니다.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  명단을 입력하는 방법은 두 가지입니다.

  [ 방법 A ]  파일 직접 열기
    ① [엑셀 파일 열기] 또는 [HWP 파일 열기] 버튼을 클릭합니다.
    ② 파일을 선택하면 자동으로 텍스트 입력창에 불러옵니다.
    ③ [명단 추출 →] 버튼을 클릭합니다.

  [ 방법 B ]  복사·붙여넣기
    ① 엑셀이나 한글 문서에서 소속기관(A열)·이름(B열) 범위를 선택합니다.
    ② Ctrl+C 로 복사합니다.
    ③ 텍스트 입력창 안을 클릭하고 Ctrl+V 로 붙여넣습니다.
    ④ [명단 추출 →] 버튼을 클릭합니다.

  ▶ 추출 결과 목록 활용
    · 더블클릭:  해당 항목의 소속기관·이름을 직접 수정할 수 있습니다.
    · Delete 키 또는 [선택 항목 삭제]:  선택한 항목을 제거합니다.
    · 빨간색 항목:  자동 선택에 실패한 항목 (검색 결과 없음)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ③ [▶ 자동 선택 시작] 버튼을 클릭합니다.
  ④ 자동으로 이름을 검색하고 결과를 더블클릭하여 추가합니다.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  A. 소속기관명을 인식하지 못한 경우입니다.
     추출된 목록에서 해당 항목을 더블클릭하면 직접 수정할 수 있습니다.
  ...
  A. [2. 위치 설정] 탭의 '검색 후 대기 시간'을 조절하세요.
     느린 PC나 인터넷: 1.5~2.5초 / 빠른 환경: 0.5~1.0초

  Q. 동명이인이 있어서 잘못 선택될까 봐 걱정돼요.
  A. '수동 확인 모드'를 체크하세요.
     검색 후 소통메신저 결과에서 직접 더블클릭하여 선택한 뒤
     [▶▶ 계속] 버튼을 누릅니다.

  Q. HWP 파일을 열었는데 내용이 안 나와요.
  A. 한/글이 설치되지 않은 경우 일부 파일이 열리지 않을 수 있습니다.
     한글 문서에서 표를 Ctrl+C로 복사 후
     텍스트 입력창에 Ctrl+V로 붙여넣어 사용하세요.
